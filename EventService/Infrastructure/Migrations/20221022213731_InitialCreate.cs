...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_ConferenceSubscriptions", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_EventReviews", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_ExhibitionProposals", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_Exhibitions", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_Members", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_EventParticipants", x => new { x.ParticipantId, x.EventId, x.DecisionDate });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_EventWaitlistMembers", x => new { x.MemberId, x.EventId, x.SignUpDate });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_ExhibitionMembers", x => new { x.MemberId, x.ExhibitionId, x.JoinedDate });
                _ = table.ForeignKey(
